...
print(factorial_iterative(5))  # Output: 120 (5! = 5 * 4 * 3 * 2 * 1 = 120)
print(factorial_iterative(0))  # Output: 1 (0! = 1)
print(factorial_iterative(1))  # Output: 1 (1! = 1)
print(factorial_iterative(4))  # Output: 24 (4! = 4 * 3 * 2 * 1 = 24)
...
# For the return, each time we still have a factoral to calculate, we cannot
# give the final answer since we still have an unknown. Once we have a return
# with no oustanding calculations, then we can work our way back to produce 
# the final answer.
...
print(factorial(4))  # Output: 24 (4! = 4 * 3 * 2 * 1 = 24)
...
print(fibonacci_iterative(6))  # Output: 8 (6th Fibonacci number is 8)
print(fibonacci_iterative(0))  # Output: 0 (0th Fibonacci number is 0)
print(fibonacci_iterative(1))  # Output: 1 (1st Fibonacci number is 1)
print(fibonacci_iterative(10)) # Output: 55 (10th Fibonacci number is 55)
...
result = fibonacci(6)
print(result)
print(fibonacci(6))  # Output: 8 (6th Fibonacci number is 8)
print(fibonacci(0))  # Output: 0 (0th Fibonacci number is 0)
print(fibonacci(1))  # Output: 1 (1st Fibonacci number is 1)
print(fibonacci(10)) # Output: 55 (10th Fibonacci number is 55)
...
print(sum_of_digits_iterative(456))   # Output: 15 (4 + 5 + 6 = 15)
print(sum_of_digits_iterative(98765)) # Output: 35 (9 + 8 + 7 + 6 + 5 = 35)
...
print(sum_of_digits(98765)) # Output: 35 (9 + 8 + 7 + 6 + 5 = 35)
...
print(power_iterative(5, 2))  # Output: 25 (5^2 = 5 * 5 = 25)
print(power_iterative(3, 4))  # Output: 81 (3^4 = 3 * 3 * 3 * 3 = 81)
...
print(power(5, 2))  # Output: 25 (5^2 = 5 * 5 = 25)
print(power(3, 4))  # Output: 81 (3^4 = 3 * 3 * 3 * 3 = 81)

#     ============ Stack Overflow ============

# Too Many Recursive Calls: Even if the base case exists, 
# too many recursive calls (e.g., large input) can exhaust the stack memory 
...
deep_recursion(1000)  # Too many calls
