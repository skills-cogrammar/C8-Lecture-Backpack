...
# ----------------------------------
sorted_list = sorted([5, 4, 7, 3, 7, 9, 4, 5, 6, 6, 3, 8, 0, 2, 36])
print(sorted_list)
# ----------------------------------
...
def access_global():
    print(global_variable)  # This will work as 'global_variable' is accessible anywhere in the program
...
def local_scope_example():
    ...
    print(local_variable)  # This will work as 'local_variable' is accessible within this function

local_scope_example()
print(local_variable)  # This would raise a NameError because 'local_variable' is not accessible outside the function
...
def function_a():
    function_b()  # This will call the next function

def function_b():
    function_c()  # This will call another function
...
# ====== Main Code ============
function_a()        # Let Python decide how to deal with the error

"""
If you want to control the error handling, place the code in a try: and
call the trace in the except: statement. Remember to import traceback.
"""
"""
try:
    function_a()  # Start the chain of function calls
except Exception as e:
    # Print a descriptive stack trace
    print("An error occurred:")
    traceback.print_exc()  # This will print a detailed stack trace
"""
...
def positives_only(func):
    # Define a wrapper function that will modify the behaviour of the original function
    def wrapper(values):
